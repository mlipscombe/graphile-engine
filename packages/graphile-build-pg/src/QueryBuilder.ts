...
function callIfNecessaryArray<T>(o: Array<Gen<T> | T>, context: GenContext): Array<T> {
  if (Array.isArray(o)) {
...
class QueryBuilder {
  ...
  orderBy(exprGen: SQLGen, ascending: boolean = true, nullsFirst: boolean | null) {
  ...
  buildWhereClause(includeLowerBound: boolean, includeUpperBound: boolean, {
    addNullCase
  }: {
    addNullCase?: boolean;
  }) {
