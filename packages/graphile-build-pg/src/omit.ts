import { PgProc, PgClass, PgAttribute, PgConstraint } from "./plugins/PgIntrospectionPlugin";
/*
...
export default function omit(entity: PgProc | PgClass | PgAttribute | PgConstraint, permission: string) {
