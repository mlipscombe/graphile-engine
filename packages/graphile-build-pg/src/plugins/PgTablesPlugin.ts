...
export default (function PgTablesPlugin(builder, {
  ...
  builder.hook("init", (_, build) => {
    ...
    introspectionResultsByKind.class.forEach(table => {
      ...
      const shouldHaveNodeId: boolean = nodeIdFieldName && table.isSelectable && table.namespace && primaryKeys && primaryKeys.length ? true : false;
      let TableType;
      let TablePatchType;
