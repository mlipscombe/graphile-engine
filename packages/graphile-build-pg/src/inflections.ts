...
export const newInflector = (overrides: {
  ...
  return preventEmptyResult(Object.assign({
    ...
    orderByEnum(name: string, ascending: boolean, _table: string, _schema: string | null | undefined) {
    ...
    singleRelationByKeys(detailedKeys: Keys, table: string, schema: string | null | undefined) {
    ...
    rowByUniqueKeys(detailedKeys: Keys, table: string, schema: string | null | undefined) {
      return camelCase(`${this.tableName(table, schema)}-by-${detailedKeys.map(key => this.column(key.column, key.table, key.schema)).join("-and-")}`);
    },

    updateByKeys(detailedKeys: Keys, table: string, schema: string | null | undefined) {
    ...
    deleteByKeys(detailedKeys: Keys, table: string, schema: string | null | undefined) {
    ...
    updateByKeysInputType(detailedKeys: Keys, name: string, _schema: string | null | undefined) {
    ...
    deleteByKeysInputType(detailedKeys: Keys, name: string, _schema: string | null | undefined) {
    ...
    manyRelationByKeys(detailedKeys: Keys, table: string, schema: string | null | undefined, _foreignTable: string, _foreignSchema: string | null | undefined) {
    ...
    scalarFunctionConnection(procName: string, _procSchema: string | null | undefined) {
      return upperCamelCase(`${procName}-connection`);
    },

    scalarFunctionEdge(procName: string, _procSchema: string | null | undefined) {
